namespace Api.SwaggerExamples.Responses
{
    ...
    public class LoginUserRequestResponseModel : IExamplesProvider<LoginUserResponseModel>
    {
        ...
        public LoginUserResponseModel GetExamples()
            => new LoginUserResponseModel { Token = ExampleToken };
    }
}
